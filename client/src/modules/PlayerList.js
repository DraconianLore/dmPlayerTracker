...
// test data
const testdata = [
  { id: 1, playerName: 'Player1', charName: 'Character Name 1', background: 'Hermit', classname: 'Monk', race: 'Human', speed: 30, proficiency: 2, hp: 22, maxHp: 22, AC: 12, saveDc: 8, hitDie: 'd8', baseSTR: 11, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(2).png" },
  { id: 2, playerName: 'Player2', charName: 'Character Name 2', background: 'Hermit', classname: 'Barbarian', race: 'Dwarf', speed: 30, proficiency: 2, hp: 22, maxHp: 22, AC: 12, saveDc: 10, hitDie: 'd8', baseSTR: 12, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(6).png" },
  { id: 3, playerName: 'Player3', charName: 'Character Name 3', background: 'Hermit', classname: 'Sorcerer', race: 'Human', speed: 30, proficiency: 2, hp: 22, maxHp: 22, AC: 12, saveDc: 10, hitDie: 'd8', baseSTR: 15, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(81).png" },
  { id: 4, playerName: 'Player4', charName: 'Character Name 4', background: 'Hermit', classname: 'Fighter', race: 'Dragonborn', speed: 30, proficiency: 2, hp: 22, maxHp: 22, AC: 12, saveDc: 10, hitDie: 'd8', baseSTR: 16, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(8).png" },
  { id: 5, playerName: 'Player5', charName: 'Character Name 5', background: 'Hermit', classname: 'Rogue', race: 'Human', speed: 30, proficiency: 2, hp: 22, maxHp: 22, ac: 12, saveDc: 15, hitDie: 'd8', baseSTR: 9, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(93).png", abilities: [{id: 1, name: 'Darkvision', description: 'Accustomed to twilit forests and the night sky, you have superior vision in dark and dim conditions. You can see in dim light within 60 feet of you as if it were bright light, and in darkness as if it were dim light. You cant discern color in darkness, only shades of gray'}, {id: 2, name: 'Fey Ancestry', description: "You have advantage on saving throws against being charmed, and magic can't put you to sleep"}]},
  { id: 6, playerName: 'Player6', charName: 'Character Name 6', background: 'Hermit', classname: 'Warlock', race: 'Half-elf', speed: 30, proficiency: 2, hp: 22, maxHp: 22, AC: 12, saveDc: 10, hitDie: 'd8', baseSTR: 7, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(31).png", proficiencies: [{id: 'intS', val: true}, {id: 'conS', val: true}]  },
  { id: 7, playerName: 'Player7', charName: 'Character Name 7', background: 'Hermit', classname: 'Ranger', race: 'Elf', speed: 30, proficiency: 2, hp: 122, maxHp: 140, AC: 12, saveDc: 11, hitDie: 'd12', baseSTR: 19, baseDEX: 13, baseCON: 10, baseINT: 11, baseWIS: 15, baseCHA: 9, portrait: "/images/original_(43).png", proficiencies: [{id: 'dexSte', val: true}, {id: 'dexSli', val: true}, {id: 'dexAcr', val: true}, {id: 'dexS', val: true}, {id: 'chaPerf', val: true}, {id: 'chaInt', val: true}, {id: 'chaDec', val: true}, {id: 'chaS', val: true}, {id: 'dexS', val: true}] },
]
